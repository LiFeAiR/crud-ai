...
func (r *userRepository) CreateUser(user *models.User) (*models.User, error) {
	...
	err := r.db.GetConnection().QueryRow(context.Background(), query, user.Name, user.Email).Scan(&user.ID)
	if err != nil {
...
func (r *userRepository) UpdateUser(user *models.User) error {
	...
	_, err := r.db.GetConnection().Exec(context.Background(), query, user.Name, user.Email, user.ID)
	if err != nil {
